...
<%
	...
	if(request.getParameter("login") != null){
		List<UsersModel> user = mUserController.login(request.getParameter("email"), request.getParameter("password"));
		if (user.size() > 0) Contracts.USER = user.get(0);
		System.out.print("login Success " + user.get(0).getEmail());
	}
%>
      ...
      <div class="container">
        <div class="row no-gutters justify-content-center mb-5 pb-5">
          <div class="col-md-7 text-center heading-section ftco-animate">
            <h2>Login</h2>
            <%
            	if(Contracts.USER != null  && request.getParameter("login") != null){
            		%>
            		<div class="alert alert-primary" role="alert">
					  Login Success! go buy your food,
					</div>
            		<%
            	}else if (Contracts.USER == null && request.getParameter("login") != null){
            		%>
            		<div class="alert alert-warning" role="alert">
					  Login False, try again!
					</div>
            		<%
            	}
            %>
            ...
            <form action="#" method="post">
              <div class="row">
                ...
                <div class="col-md-12 mt-3">
                  <div class="form-group">
                    <input type="submit" name="login" value="Make a Reservation" class="btn btn-primary py-3 px-5">
                  </div>
                </div>
              </div>
            </form>
